...
$featurearray = array("Pick up method" => array("Pick up in store","Pick up in convenience point through lockers","Home/ office delivery"),"Distance" => array("< 1 Km","1 - 2.5 Km","2.5 - 5 Km","> 5 Km"),"Delivery time window" => array("Early mornings","Working hours","Late nights","Anytime"),"Delivery lead time" => array("Same day","Next day","Two days","> Two days"),"Delivery cost" => array("$5","$3","$1","Free"));

$restrictionarray = array(array(array("Pick up method","Pick up in store"),array("Delivery time window","Early mornings")),array(array("Delivery time window","Late nights"),array("Pick up method","Pick up in store")),array(array("Pick up method","Pick up in store"),array("Delivery time window","Anytime")),array(array("Pick up method","Home/ office delivery"),array("Distance","1 - 2.5 Km")),array(array("Distance","2.5 - 5 Km"),array("Pick up method","Home/ office delivery")),array(array("Pick up method","Home/ office delivery"),array("Distance","> 5 Km")),array(array("Pick up method","Pick up in convenience point through lockers"),array("Delivery time window","Early mornings")),array(array("Delivery time window","Working hours"),array("Pick up method","Pick up in convenience point through lockers")),array(array("Pick up method","Pick up in convenience point through lockers"),array("Delivery time window","Late nights")));
...
$attrconstraintarray = array(array("Pick up method","Delivery lead time","Delivery cost","Delivery time window","Distance"));
